...
declare type Phaser$Any$Body =
  | Phaser$Physics$Arcade$Body
  | Phaser$Physics$P2$Body
  | Phaser$Physics$Ninja$Body
  | any;
declare type Phaser$Physics$Ninja$TileType =
  | 'TYPE_EMPTY'
  | 'TYPE_FULL'
  | 'TYPE_45DEG'
  | 'TYPE_CONCAVE'
...
declare class Phaser$Animation {
  constructor(
    game: Phaser$Game,
...
declare class Phaser$AnimationManager {
...
declare class Phaser$AnimationParser {
...
declare class Phaser$AudioSprite {
...
declare class Phaser$ArrayUtils {
...
declare class Phaser$BitmapData {
  constructor(
    game: Phaser$Game,
    key: string,
    width?: number,
...
declare class Phaser$BitmapText {
  constructor(
    game: Phaser$Game,
    x: number,
    y: number,
...
declare class Phaser$PointerMode {
  CURSOR: number,
  CONTACT: number,
}

declare class Phaser$Cache {
...
declare class Phaser$DeviceButton {
  constructor(
...
declare class Phaser$Back {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Bounce {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Circular {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Cubic {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Elastic {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Exponential {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Linear {
  None(k: number): number,
}

declare class Phaser$Quadratic {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Quartic {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Quintic {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Sinusoidal {
  In(k: number): number,
  Out(k: number): number,
  InOut(k: number): number,
}

declare class Phaser$Ellipse {
...
declare class Phaser$BinarySerpents {
  constructor(
    game: Phaser$Game,
    width: number,
    height: number,
...
declare class Phaser$BlurX {
  blur: number,
}

declare class Phaser$BlurY {
  blur: number,
}

declare class Phaser$CausticLight {
  constructor(
    game: Phaser$Game,
    width: number,
    height: number,
...
declare class Phaser$CheckerWave {
...
declare class Phaser$ColorBars {
  constructor(game: Phaser$Game, width: number, height: number): this,
  alpha: number,
  init(width: number, height: number): void,
}

declare class Phaser$Fire {
  constructor(
    width: number,
    height: number,
    alpha?: number,
...
declare class Phaser$Gray {
  gray: number,
}

declare class Phaser$HueRotate {
  constructor(
    game: Phaser$Game,
    width: number,
    height: number,
...
declare class Phaser$LazerBeam {
  init(width: number, height: number, divisor?: number): void,
}

declare class Phaser$LightBeam {
  constructor(game: Phaser$Game, width: number, height: number): this,
  alpha: number,
  blue: number,
  green: number,
...
declare class Phaser$Pixelate {
  size: number,
  sizeX: number,
  sizeY: number,
}

declare class Phaser$Plasma {
  constructor(
    game: Phaser$Game,
    width: number,
    height: number,
...
declare class Phaser$SampleFilter {
  constructor(
    game: Phaser$Game,
    width: number,
    height: number,
...
declare class Phaser$FlexLayer {
  constructor(
    manager: Phaser$ScaleManager,
    position: Phaser$Point,
    bounds: Phaser$Rectangle,
...
declare class Phaser$FrameData {
  total: number,
...
declare class Phaser$GameObjectCreator {
  constructor(game: Phaser$Game): this,
  game: Phaser$Game,
  world: Phaser$World,
  audio(
...
declare class Phaser$GameObjectFactory {
  constructor(game: Phaser$Game): this,
  game: Phaser$Game,
  world: Phaser$World,
  audio(
...
declare class Phaser$Graphics extends PIXI.Graphics {
...
declare class Phaser$ImageCollection {
  constructor(
    name: string,
    firstgid: number,
    width?: number,
...
declare class Phaser$InputHandler {
  constructor(sprite: Phaser$Sprite): this,
...
declare class Phaser$LinkedList {
  first: any,
  last: any,
  next: any,
  prev: any,
...
declare class Phaser$LoaderParser {
  bitmapFont(
    xml: any,
    baseTexture: PIXI.BaseTexture,
    xSpacing?: number,
...
declare class Phaser$MSPointer {
  constructor(game: Phaser$Game): this,
  button: number,
  capture: boolean,
  callbackContext: any,
...
declare class Phaser$Particles {
  constructor(game: Phaser$Game): this,
  emitters: any,
  game: Phaser$Game,
  ID: number,
...
declare class Phaser$Particles$Arcade$Emitter {
  constructor(
    game: Phaser$Game,
    x?: number,
    y?: number,
...
declare class Phaser$Video {
  ...
  add(
    object: Phaser$Sprite | Phaser$Sprite[] | Phaser$Image | Phaser$Image[],
  ): Phaser$Video,
  addToWorld(
    x?: number,
    y?: number,
...
declare class Phaser$Physics$Arcade {
  SORT_NONE: number,
  LEFT_RIGHT: number,
  RIGHT_LEFT: number,
  TOP_BOTTOM: number,
...
declare class Phaser$Physics$Arcade$Body {
  constructor(sprite: Phaser$Sprite): this,
  ...
  blocked: Phaser$Physics$Arcade$FaceChoices,
  bottom: number,
  bounce: Phaser$Point,
  center: Phaser$Point,
...
declare class Phaser$Physics$Arcade$FaceChoices {
  none: boolean,
  any: boolean,
  up: boolean,
  down: boolean,
...
declare class Phaser$Physics$Ninja {
  constructor(game: Phaser$Game): this,
  game: Phaser$Game,
  gravity: number,
  bounds: Phaser$Rectangle,
...
declare class Phaser$Physics$Ninja$Body {
  constructor(
...
declare class Phaser$Physics$Ninja$AABB {
  constructor(
    body: Phaser$Physics$Ninja$Body,
    x: number,
    y: number,
...
declare class Phaser$Physics$Ninja$Circle {
  constructor(
    body: Phaser$Physics$Ninja$Body,
    x: number,
    y: number,
...
declare class Phaser$Physics$Ninja$Tile {
  constructor(
    body: Phaser$Physics$Ninja$Body,
    x: number,
    y: number,
...
declare class Phaser$Physics$P2 {
  constructor(game: Phaser$Game, config?: any): this,
...
declare class Phaser$Physics$P2$Body {
  ['static']: boolean,
  DYNAMIC: number,
  STATIC: number,
  KINEMATIC: number,
...
declare class Phaser$Physics$P2$BodyDebug {
  constructor(
    game: Phaser$Game,
    body: Phaser$Physics$P2$Body,
    settings: {
...
declare class Phaser$Physics$P2$CollisionGroup {
  constructor(bitmask: number): this,
  mask: number,
}

declare class Phaser$Physics$P2$ContactMaterial {}

declare class Phaser$Physics$P2$DistanceConstraint {
  constructor(
    world: Phaser$Physics$P2,
...
declare class Phaser$Physics$P2$FixtureList {
  constructor(list: any[]): this,
...
declare class Phaser$Physics$P2$GearConstraint {
  constructor(
    world: Phaser$Physics$P2,
    bodyA: Phaser$Physics$P2$Body,
    bodyB: Phaser$Physics$P2$Body,
...
declare class Phaser$Physics$P2$InversePointProxy {
  constructor(world: Phaser$Physics$P2, destination: any): this,
  x: number,
  y: number,
  mx: number,
  my: number,
...
declare class Phaser$Physics$P2$LockConstraint {
  constructor(
    world: Phaser$Physics$P2,
    bodyA: Phaser$Physics$P2$Body,
    bodyB: Phaser$Physics$P2$Body,
...
declare class Phaser$Physics$P2$Material {
  constructor(name: string): this,
  name: string,
}

declare class Phaser$Physics$P2$PointProxy {
  constructor(world: Phaser$Physics$P2, destination: any): this,
  x: number,
  y: number,
  mx: number,
...
declare class Phaser$Physics$P2$PrismaticConstraint {
  constructor(
    world: Phaser$Physics$P2,
    bodyA?: Phaser$Physics$P2$Body,
    bodyB?: Phaser$Physics$P2$Body,
...
declare class Phaser$Physics$P2$RevoluteConstraint {
  constructor(
    world: Phaser$Physics$P2,
    bodyA: Phaser$Physics$P2$Body,
    pivotA: number[],
...
declare class Phaser$Physics$P2$Spring {
  constructor(
    world: Phaser$Physics$P2,
    bodyA: Phaser$Physics$P2$Body,
    bodyB: Phaser$Physics$P2$Body,
...
declare class Phaser$Plugin$SaveCPU {
  renderOnFPS: number,
  renderOnPointerChange: boolean,
  forceRender(): void,
}

declare class Phaser$Plugin$AStar {
  VERSION: string,
...
declare class Phaser$Plugin$AStar$AStarNode {
...
declare class Phaser$Plugin$AStar$AStarPath {
  constructor(
    nodes?: {
      x: number,
      y: number,
...
declare class Phaser$ColorHarmony {
...
declare class Phaser$CSS3Filters {
  constructor(parent: PIXI.DisplayObject): this,
  blur: number,
  brightness: number,
  contrast: number,
...
declare class Phaser$TilemapWalker {
  constructor(
    game: Phaser$Game,
    map: Phaser$Tilemap,
    layer?: any,
...
declare class Phaser$Plugin$Juicy {
  constructor(game: Phaser$Game): this,
...
declare class Phaser$Plugin$Juicy$Trail {
...
declare class Phaser$Plugin$Juicy$ScreenFlash {
...
declare class Phaser$PluginManager {
  constructor(game: Phaser$Game): this,
  game: Phaser$Game,
...
declare class Phaser$RandomDataGenerator {
...
declare class Phaser$Rectangle {
  constructor(x: number, y: number, width: number, height: number): this,
  bottom: number,
  bottomRight: Phaser$Point,
  bottomLeft: Phaser$Point,
...
declare class Phaser$RenderTexture {
  constructor(
    game: Phaser$Game,
    width?: number,
    height?: number,
...
declare class Phaser$RequestAnimationFrame {
...
declare class Phaser$RetroFont {
  constructor(
    game: Phaser$Game,
    key: string,
    characterWidth: number,
...
declare class Phaser$RoundedRectangle {
  x: number,
  y: number,
  width: number,
  height: number,
...
declare class Phaser$SignalBinding {
  constructor(
...
declare class Phaser$SinglePad {
...
declare class Phaser$SoundManager {
  constructor(game: Phaser$Game): this,
  channels: number,
...
declare class Phaser$SpriteBatch {
  constructor(
    game: Phaser$Game,
    parent: PIXI.DisplayObjectContainer,
    name?: string,
...
declare class Phaser$ScaleManager {
  constructor(
    game: Phaser$Game,
    width: number | string,
    height: number | string,
...
declare class Phaser$TilemapLayer {
  constructor(
    game: Phaser$Game,
...
declare class Phaser$TilemapLayerGL {
  constructor(
    game: Phaser$Game,
    tilemap: Phaser$Tilemap,
    index: number,
...
declare class Phaser$TilemapParser {
  INSERT_NULL: boolean,
  getEmptyData(
    tileWidth?: number,
    tileHeight?: number,
...
declare class Phaser$TileSprite {
  constructor(
    game: Phaser$Game,
    x: number,
    y: number,
...
declare class Phaser$TimerEvent {
  constructor(
    timer: Phaser$Timer,
    delay: number,
    tick: number,
...
declare class Phaser$TweenData {
...
declare class Phaser$TweenManager {
  constructor(game: Phaser$Game): this,
  frameBased: boolean,
  game: Phaser$Game,
...
declare class Phaser$Utils$Debug {
  constructor(game: Phaser$Game): this,
  bmd: Phaser$BitmapData,
  canvas: HTMLCanvasElement,
  columnWidth: number,
